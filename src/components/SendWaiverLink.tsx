...
import { createAndSendSigningLink } from "@/app/waivers/actions";

export default function SendWaiverLink({
  waiverId,
  facilityId,
  parentId,
  signerName,
  ...
  function send() {
    startTransition(async () => {
      const r = await createAndSendSigningLink(waiverId, facilityId, parentId, signerName, phone);
      setResult(r);
    });
  }
