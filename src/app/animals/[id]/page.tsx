    ...
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="mx-auto max-w-3xl px-4 py-6 sm:px-6 sm:py-8">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-3">
          ...
          <Link href={`/animals/${id}/reservations`} className="text-sm text-indigo-600 underline dark:text-indigo-400">
            📋 Visit History
          </Link>
          <Link href={`/animals/${id}/invoices`} className="text-sm text-indigo-600 underline dark:text-indigo-400">
            🧾 Receipts
          </Link>
          <Link
        ...
        {parent && (
          <p className="text-sm text-slate-400 dark:text-slate-500">
            Parent:{" "}
            <Link href={`/parents/${parent.id}`} className="underline">
