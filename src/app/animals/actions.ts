...
export async function createAnimal(formData: FormData) {
  ...
  const { data, error } = await supabase
    ...
    .insert({
      ...
      rabies_expiration: str(formData, "rabies_expiration"),
      distemper_expiration: str(formData, "distemper_expiration"),
      bordetella_expiration: str(formData, "bordetella_expiration"),
