    ...
    <main className="min-h-screen bg-neutral-100 dark:bg-neutral-950">
      ...
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 sm:py-8">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <a href="/lodging" className="text-sm text-neutral-400 underline dark:text-neutral-500">
            Same-day board →
          </a>
        </div>
        ...
        <div className="mt-3 flex items-center gap-2 text-sm">
          <a
            ...
            className="rounded-md border border-neutral-300 px-2 py-1 hover:border-neutral-500 dark:border-neutral-700 dark:hover:border-neutral-500"
          >
            ← Week
          </a>
          <span className="font-medium">{weekLabel}</span>
          {!thisWeek && (
            <a href="/lodging/calendar" className="text-xs text-neutral-400 underline dark:text-neutral-500">
              This Week
            </a>
          )}
          <a
